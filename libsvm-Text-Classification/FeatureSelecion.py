...
#二分类
ClassCode = ['C000013', 'C000020']
#多分类
#ClassCode =['C000008', 'C000010', 'C000013', 'C000014', 'C000016', 'C000020', 'C000022','C000023', 'C000024']
# 构建每个类别的词Set
                ...
                if eachclass == key: #在这个类别下进行处理
                    for eachdocset in termClassDic[eachclass]:
                        if eachword in eachdocset:
                            a = a + 1  #在这个分类下包含这个词的文档数量
                        else:
                            c = c + 1  #在这个分类下不包含这个词的文档数量
                else: # 不在这个类别下进行处理
                    for eachdocset in termClassDic[eachclass]:
                        if eachword in eachdocset:
                            b = b + 1  # 不在该分类下包含这个词的文档数量
                        else:
                            d = d + 1  # 不在该分类下，且不包含这个词的文档数量
